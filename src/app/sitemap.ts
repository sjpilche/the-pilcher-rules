...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/diagnostic`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.95 },
    { url: `${base}/data-rehab`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
