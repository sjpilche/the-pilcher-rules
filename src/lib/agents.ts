...
export const AGENTS: Agent[] = [
  ...
  {
    slug: "margin-fade",
    name: "Margin Fade Detector",
    tagline: "Catch profit erosion before it hits the P&L.",
    description:
      "Continuously monitors every active job's projected GP against original bid margin. When margin fades 2+ points, you know about it the morning it happens — not at month-end close.",
    color: "#ef4444",
    bgColor: "rgba(239,68,68,0.08)",
    borderColor: "rgba(239,68,68,0.25)",
    glowColor: "rgba(239,68,68,0.15)",
    icon: "📉",
    category: "Intelligence",
    companyTypes: ["GC", "Subcontractor", "PE-Backed"],
    capabilities: [
      "Bid margin vs projected GP tracking",
      "Committed cost overage detection",
      "EAC-exceeds-budget alerts",
      "Portfolio-wide fade scan (nightly)",
      "90-day trend history per job",
      "Red/Amber/Green severity classification",
    ],
    metrics: [
      { label: "Detection Speed", value: "Next morning" },
      { label: "Fade Threshold", value: "2 pts" },
      { label: "Coverage", value: "All active jobs" },
    ],
    status: "production",
  },
  {
    ...
    tagline: "0-100 composite score for every active project.",
    description:
      "Weighted risk scoring across 5 dimensions — margin health, schedule performance, change order exposure, subcontractor performance, and customer payment behavior. Portfolio heat map shows exactly where risk is concentrating.",
    color: "#f97316",
    bgColor: "rgba(249,115,22,0.08)",
    borderColor: "rgba(249,115,22,0.25)",
    glowColor: "rgba(249,115,22,0.15)",
    icon: "🎯",
    category: "Intelligence",
    companyTypes: ["GC", "Multi-Entity", "PE-Backed"],
    capabilities: [
      "5-dimension weighted risk scoring",
      "Portfolio heat map visualization",
      "Red/Amber/Green risk banding",
      "Daily score trending (90-day history)",
      "Drill-down to dimension-level detail",
      "Schedule slip and CO exposure tracking",
    ],
    metrics: [
      { label: "Dimensions", value: "5 weighted" },
      { label: "Update Frequency", value: "Nightly" },
      { label: "Risk Bands", value: "RED / AMBER / GREEN" },
    ],
    status: "production",
  },
  {
    slug: "cfo-health",
    name: "CFO Health Score",
    tagline: "One number that tells you if the business is OK.",
    description:
      "Composite 0-100 financial health score across 6 dimensions: liquidity, profitability, project health, cash conversion, compliance, and growth quality. Letter-graded A through F with 52-week trending.",
    color: "#10b981",
    bgColor: "rgba(16,185,129,0.08)",
    borderColor: "rgba(16,185,129,0.25)",
    glowColor: "rgba(16,185,129,0.15)",
    icon: "💚",
    category: "Intelligence",
    companyTypes: ["GC", "Multi-Entity", "PE-Backed", "Subcontractor"],
    capabilities: [
      "6-dimension composite health score",
      "A/B/C/D/F letter grading",
      "52-week trend tracking",
      "Configurable dimension weights",
      "Executive dashboard integration",
      "Automated score computation (nightly)",
    ],
    metrics: [
      { label: "Dimensions", value: "6 weighted" },
      { label: "History", value: "52 weeks" },
      { label: "Grading", value: "A through F" },
    ],
    status: "production",
  },
  {
    slug: "covenant-monitor",
    name: "Covenant Monitor",
    tagline: "Never be surprised by a covenant breach.",
    description:
      "Tracks leverage ratios, FCCR, minimum liquidity, and senior leverage against lender-defined thresholds. Projects days-to-breach using trend analysis and shows 13-week forward headroom.",
    color: "#8b5cf6",
    bgColor: "rgba(139,92,246,0.08)",
    borderColor: "rgba(139,92,246,0.25)",
    glowColor: "rgba(139,92,246,0.15)",
    ...
    companyTypes: ["PE-Backed", "Multi-Entity"],
    capabilities: [
      "Leverage ratio and FCCR tracking",
      "Minimum liquidity compliance",
      "Days-to-breach projection",
      "13-week forward headroom view",
      "Lender threshold management",
      "Breach-projected alerting",
    ],
    metrics: [
      { label: "Covenant Types", value: "4 supported" },
      { label: "Projection", value: "13 weeks" },
      { label: "Monitoring", value: "Nightly" },
    ],
    status: "production",
  },
  {
    slug: "ebitda-bridge",
    name: "EBITDA Bridge",
    tagline: "Decompose exactly why earnings changed.",
    description:
      "Period-over-period EBITDA variance decomposition into 7 components: revenue volume, revenue rate, project mix, direct cost, overhead, normalizations, and residual. Audit-grade confidence with GL-sourced data.",
    color: "#0ea5e9",
    bgColor: "rgba(14,165,233,0.08)",
    borderColor: "rgba(14,165,233,0.25)",
    glowColor: "rgba(14,165,233,0.15)",
    ...
    companyTypes: ["PE-Backed", "Multi-Entity", "GC"],
    capabilities: [
      "7-component variance decomposition",
      "GL-sourced high-confidence mode",
      "Period-over-period waterfall charts",
      "LLM-generated narrative explanations",
      "Multi-company bridge support",
      "Nightly automated computation",
    ],
    metrics: [
      { label: "Components", value: "7 decomposition" },
      { label: "Confidence", value: "GL-validated" },
      { label: "Narrative", value: "AI-generated" },
    ],
    status: "production",
  },
  {
    slug: "wip-analyzer",
    name: "WIP Analyzer",
    tagline: "Underbilled, overbilled, and everything in between.",
    description:
      "Monthly work-in-progress snapshot engine that calculates billing variance (earned value minus billings) for every active job. Generates close checklists with severity-tagged action items.",
    color: "#eab308",
    ...
    icon: "🏗️",
    category: "Operations",
    companyTypes: ["GC", "Subcontractor", "Multi-Entity"],
    capabilities: [
      "Billing variance calculation per job",
      "Underbilled/overbilled classification",
      "Close checklist generation",
      "Significant variance flagging ($50K+)",
      "Monthly snapshot trending",
      "Margin fade integration",
    ],
    metrics: [
      { label: "Threshold", value: "$50K significant" },
      { label: "Frequency", value: "Monthly (1st)" },
      { label: "Checklist", value: "Auto-generated" },
    ],
    status: "production",
  },
  {
    ...
    tagline: "13-week cash visibility with LOC optimization.",
    description:
      "Weekly rolling 13-week cash forecast built from GL opening balances, AR collection schedule, AP disbursement schedule, and payroll estimates. Includes line-of-credit draw/repayment recommendations and liquidity scoring.",
    color: "#06b6d4",
    bgColor: "rgba(6,182,212,0.08)",
    borderColor: "rgba(6,182,212,0.25)",
    glowColor: "rgba(6,182,212,0.15)",
    ...
    capabilities: [
      ...
      "AR/AP schedule-based projections",
      "LOC draw/repayment recommendations",
      "Minimum cash buffer alerts",
      "Liquidity scoring (A-F grade)",
      "Weekly payroll estimation",
    ],
    metrics: [
      { label: "Forecast Window", value: "13 weeks" },
      { label: "Update", value: "Weekly (Mon)" },
      { label: "Scoring", value: "A through F" },
    ],
    status: "production",
  },
  {
    slug: "investor-reports",
    name: "Investor Report Engine",
    tagline: "PE-grade LP reports assembled automatically.",
    description:
      "Assembles 7-section investor report packages pulling KPIs from every intelligence agent. Includes EBITDA bridge, risk heat map, covenant status, WIP summary, treasury outlook, and AI-narrated executive summary. Benchmarked against PE construction medians.",
    color: "#a855f7",
    bgColor: "rgba(168,85,247,0.08)",
    borderColor: "rgba(168,85,247,0.25)",
    glowColor: "rgba(168,85,247,0.15)",
    ...
    companyTypes: ["PE-Backed", "Multi-Entity"],
    capabilities: [
      "7-section automated report assembly",
      "PE construction benchmark comparison",
      "LLM-narrated executive summary",
      "EBITDA bridge + covenant integration",
      "Risk heat map inclusion",
      "CFO approval workflow (RED tier)",
    ],
    metrics: [
      { label: "Sections", value: "7 automated" },
      { label: "Frequency", value: "Monthly (5th)" },
      { label: "Benchmarks", value: "PE construction" },
    ],
    status: "production",
  },
];
